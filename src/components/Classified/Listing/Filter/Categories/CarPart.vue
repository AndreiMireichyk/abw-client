<template>
  <div class="filter__body">
    <div class="filter__item col-6">
      <switch-control :filter="getByCode('car_part_condition')" v-model="getByCode('car_part_condition').value"/>
    ...
    <div class="filter__item  col-4" v-if="getByCode('car_part_type')">
      <select-control :filter="getByCode('car_part_type')" v-model="getByCode('car_part_type').value"/>
    </div>
    ...
    <div class="filter__item  col-4" v-if="getByCode('price')">
